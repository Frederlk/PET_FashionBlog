...
if (document.querySelector('.pagination-fill')) {
	...
	function createPagination(totalPages, page) {
		...
		if (page > 1) { //show the next button if the page value is greater than 1
			liTag += `<li class="pagination-fill__prev _icon-down" onclick="createPagination(totalPages, ${page - 1})">OLDER POST<span></span></li>`;
		}
		...
		if (page < totalPages) { //show the next button if the page value is less than totalPage(20)
			liTag += `<li class="pagination-fill__next _icon-down" onclick="createPagination(totalPages, ${page + 1})"><span>NEXT POST</span></li>`;
		}
